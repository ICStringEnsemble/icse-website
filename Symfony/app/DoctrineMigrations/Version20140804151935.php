 ...
 */
class Version20140804151935 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE Venue CHANGE updated_by_id updated_by_id INT NOT NULL");
        ...
        $this->addSql("ALTER TABLE NewsArticle CHANGE updated_by_id updated_by_id INT NOT NULL");
        ...
        $this->addSql("ALTER TABLE PerformanceOfAPiece CHANGE piece_id piece_id INT NOT NULL, CHANGE event_id event_id INT NOT NULL");
        ...
        $this->addSql("ALTER TABLE Rehearsal CHANGE updated_by_id updated_by_id INT NOT NULL");
        ...
        $this->addSql("ALTER TABLE SentNewsletter CHANGE sent_by_id sent_by_id INT NOT NULL");
        ...
        $this->addSql("ALTER TABLE CommitteeRole CHANGE member_id member_id INT NOT NULL");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE CommitteeRole CHANGE member_id member_id INT DEFAULT NULL");
        ...
        $this->addSql("ALTER TABLE NewsArticle CHANGE updated_by_id updated_by_id INT DEFAULT NULL");
        ...
        $this->addSql("ALTER TABLE PerformanceOfAPiece CHANGE piece_id piece_id INT DEFAULT NULL, CHANGE event_id event_id INT DEFAULT NULL");
        ...
        $this->addSql("ALTER TABLE Rehearsal CHANGE updated_by_id updated_by_id INT DEFAULT NULL");
        ...
        $this->addSql("ALTER TABLE SentNewsletter CHANGE sent_by_id sent_by_id INT DEFAULT NULL");
        $this->addSql("ALTER TABLE Venue DROP FOREIGN KEY FK_50503409896DBBDE");
        $this->addSql("DROP INDEX IDX_50503409896DBBDE ON Venue");
        $this->addSql("ALTER TABLE Venue CHANGE updated_by_id updated_by_id INT DEFAULT NULL");
    }
}
