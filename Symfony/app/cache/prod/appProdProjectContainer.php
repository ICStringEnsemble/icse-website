...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => '/home/dphoyes/web_devel/union.ic.ac.uk/www/arts/stringensemble/Symfony/app/cache/prod/translations', 'debug' => false), $this->get('session'));
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, new \Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->getDefaultParameters()), '/home/dphoyes/web_devel/union.ic.ac.uk/www/arts/stringensemble/Symfony/app/../web', false);
    }
