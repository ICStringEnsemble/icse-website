 ...
 */
class Event extends \Icse\PublicBundle\Entity\Event implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'description', 'starts_at', 'updated_at', 'updated_by', 'performances', 'location', 'poster');
    }
