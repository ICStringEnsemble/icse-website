 ...
 */
class PerformanceOfAPiece extends \Icse\PublicBundle\Entity\PerformanceOfAPiece implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'piece', 'event');
    }
